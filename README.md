...
8. запустить приложение из командной строки с помощью команды (данный шаг можно пропустить, если таблицы в базе данных будут создаваться вручную):  

        java -jar <имя файла>.jar
        
    ![LAUNCH](/images/Launch.png)

9. остановить приложение, убедиться, что в базе данных создались таблицы: **field**, **index**, **lemma**, **page** и **site** (данный шаг можно пропустить, если таблицы в базе данных будут создаваться вручную):  

    ![CREATED_TABLES](/images/CreatedTables.png)

10. в файле `application.yaml` установить свойство:

        spring:jpa:hibernate:ddl-auto: none

    либо удалить данную строку из файла
    
    ![DLL_NONE](/images/DllNone.png)

11. снова запустить приложение, запустить браузер и убедиться, что приложение работает:  
    
    ![WORKING_APP](/images/WorkingApp.png)
